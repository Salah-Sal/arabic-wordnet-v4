#!/bin/bash
# Launch the concurrent batch review inside a Docker container (5-stage review pipeline).
#
...
PIPELINE_DIR="${PIPELINE_DIR:-$GUIDE_DIR/review_pipeline}"
PREPARED_DIR="${PREPARED_DIR:-$PIPELINE_DIR/prepared}"
OUTPUT_DIR="${OUTPUT_DIR:-$GUIDE_DIR/output/reviews_pipeline_v2}"
